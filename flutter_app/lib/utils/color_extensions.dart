...
extension AppSemanticColors on ColorScheme {
  Color get success =>
      brightness == Brightness.dark ? const Color(0xFF34D399) : Colors.green;
  ...
  Color get info =>
      brightness == Brightness.dark ? const Color(0xFF7C9BFF) : Colors.blue;
  Color get infoContainer => brightness == Brightness.dark
      ? const Color(0xFF7C9BFF).withValues(alpha: 0.15)
      : Colors.blue.withValues(alpha: 0.08);

  Color get danger =>
      brightness == Brightness.dark ? const Color(0xFFFC8181) : Colors.red;
  Color get dangerContainer => brightness == Brightness.dark
      ? const Color(0xFFFC8181).withValues(alpha: 0.15)
      : Colors.red.withValues(alpha: 0.08);

  Color get faculty =>
      brightness == Brightness.dark ? const Color(0xFFA78BFA) : Colors.purple;
  Color get staff =>
